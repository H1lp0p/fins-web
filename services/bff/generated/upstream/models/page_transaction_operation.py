...
T = TypeVar("T", bound="PageTransactionOperation")



@_attrs_define
class PageTransactionOperation:
    """ 
        Attributes:
            total_pages (int | Unset):
            total_elements (int | Unset):
            size (int | Unset):
            content (list[TransactionOperation] | Unset):
            number (int | Unset):
    ...
    content: list[TransactionOperation] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = TransactionOperation.from_dict(content_item_data)
        ...
        page_transaction_operation = cls(
        ...
        page_transaction_operation.additional_properties = d
        return page_transaction_operation
